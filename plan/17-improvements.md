...
- ✅ U1.1 — Конфликт сила сигнала/вердикт: единая метрика, пороги WEAK/MODERATE/STRONG/VERY STRONG.
- ✅ U1.2 — Трактовка Fear & Greed: новые пороги (20/40/60/80), F&G=27 теперь ⚠️ для лонга.
- ✅ U1.3 — ⚠️ факторы уже учитываются в скоре (weighted sum система).
- ✅ U1.4 — Направление объёма: volume_delta_pct, формат «Delta: +68% (покупки)».
- ✅ U2.1-2.3 — Уровни S/R (1H+4H): swing high/low + кластеризация, валидация vs SL/TP.
- ✅ U3.1-3.2 — Единая формула уверенности: 60% тех. скор + 40% контекст, новые пороги вердикта.
- ✅ U4.1 — Обновлён шаблон вывода: Цена входа, SL/TP с %, тех. факторы, рыночный контекст, Итог.
