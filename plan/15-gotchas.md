...
3. **Score 4/8** — минимальный порог. Реально `buy_score` / `sell_score` считают
    8 критериев: 5 уникальных + Volume (в оба score) + ADX strong (в оба) + DMI direction (ассиметричный).
    Максимум каждой стороны — 8.
